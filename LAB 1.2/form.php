...
<form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
  ...
  <input type="radio" id="age" name="age" value="30">
  <label for="age">0 - 30</label><br>
  <input type="radio" id="age" name="age" value="60">
  <label for="age">31 - 60</label><br>  
  <input type="radio" id="age" name="age" value="100">
  <label for="age">61 - 100</label><br><br>
...
<br>
<p>Tell about yourself:</P> <input type="text" name="paragraph">
  <br>
