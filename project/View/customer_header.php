            ...
            <div class="col-md-4">
                <fieldset>
                    ...
                    <ul class="list-unstyled menu">
                        <li><a class="text-info" href="customer_panel.php">Dashboard</a></li>
                        <li><a class="text-info" href="customer_info.php">View Profile</a></li>
                        <li><a class="text-info" href="customer_editprofile.php">Edit Profile</a></li>
                        <li><a class="text-info" href="customer_change_profilepic.php">Change Profile Pic</a></li>
                        <li><a class="text-info" href="customer_changepassword.php">Change Password</a></li>
                    </ul>
                </fieldset>
            </div>
        </div>
